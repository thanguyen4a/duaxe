...
public class car_people3 : ObservableMonoBehaviour {
	...
	private void randomPosition()
	{
		...
		{
			Vector3 position = this.gameObject.transform.position;
			position.x =Random.Range(-Constant.position_random_range_car_people3,+Constant.position_random_range_car_people3);
			this.gameObject.transform.position = position;
		}
	}
	...
	void OnTriggerEnter2D(Collider2D others)
	{
		...
		{   
			...
			//Debug.LogWarning("The car have passed enemy 3");
